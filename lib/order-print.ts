...
export function printTrackedOrderReceipt(
  order: TrackedOrder,
  options: {
    isArabic: boolean
    currency: string
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          h1 { margin: 0 0 5px; font-size: 20px; text-align: center; }
          .muted { color: #64748b; font-size: 12px; text-align: center; margin-bottom: 12px; }
...
export function printPrinterTest(options: { isArabic: boolean; printerMethod: string; paperWidth: string; printerName?: string }) {
