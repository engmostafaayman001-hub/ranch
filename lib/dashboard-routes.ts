...
export const dashboardLinks = [
  { href: ROUTES.DASHBOARD, labelAr: 'نظرة عامة', labelEn: 'Overview', icon: LayoutDashboard, roles: ['super_admin', 'admin', 'manager'] },
  { href: ROUTES.DASHBOARD_POS, labelAr: 'نقطة البيع', labelEn: 'POS', icon: Store, roles: ['super_admin', 'admin', 'manager', 'cashier'] },
