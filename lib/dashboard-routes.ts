...
export const dashboardLinks = [
  ...
  { href: ROUTES.DASHBOARD_ORDERS, labelAr: 'طلبات التطبيق', labelEn: 'App Orders', icon: ReceiptText, roles: ['super_admin', 'admin', 'cashier'] },
  { href: ROUTES.DASHBOARD_EXPENSES, labelAr: 'المصروفات', labelEn: 'Expenses', icon: DollarSign, roles: ['super_admin', 'admin', 'cashier'] },
  { href: ROUTES.DASHBOARD_CATEGORIES, labelAr: 'الأقسام', labelEn: 'Categories', icon: Tags, roles: ['super_admin', 'admin', 'supervisor', 'cashier'] },
  { href: ROUTES.DASHBOARD_PRODUCTS, labelAr: 'المنتجات', labelEn: 'Products', icon: Package, roles: ['super_admin', 'admin', 'supervisor', 'cashier'] },
  { href: ROUTES.DASHBOARD_NOTIFICATIONS, labelAr: 'العروض والإشعارات', labelEn: 'Offers & Notifications', icon: BellRing, roles: ['super_admin', 'admin', 'supervisor'] },
  { href: ROUTES.DASHBOARD_CUSTOMERS, labelAr: 'العملاء', labelEn: 'Customers', icon: Users, roles: ['super_admin', 'admin', 'supervisor'] },
  { href: ROUTES.DASHBOARD_PAYMENTS, labelAr: 'المدفوعات', labelEn: 'Payments', icon: CreditCard, roles: ['super_admin', 'admin', 'cashier'] },
  { href: ROUTES.DASHBOARD_DELIVERY, labelAr: 'السائقون والتوصيل', labelEn: 'Delivery', icon: Truck, roles: ['super_admin', 'admin', 'cashier'] },
  ...
  { href: ROUTES.DASHBOARD_SETTINGS, labelAr: 'الإعدادات', labelEn: 'Settings', icon: Settings, roles: ['super_admin', 'admin', 'supervisor', 'cashier'] },
] as const
